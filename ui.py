...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.question = self.canvas.create_text(150, 125, width=280, text="Heyyyyyy", font=("Arial", 20, "italic"))

        true_button_image = PhotoImage(file="images/true.png")
        false_button_image = PhotoImage(file="images/false.png")
        self.true_button = Button(image=true_button_image, command=self.true)
        self.true_button.grid(column=0, row=2)
        self.false_button = Button(image=false_button_image, command=self.false)
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            print("aaaa")
            self.canvas.itemconfig(self.question,text= "Quizz ended")
